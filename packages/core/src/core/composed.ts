...
export interface ComposedFactoryFunction {
    <T>(compute: () => T, write: (value: T) => void, equals?: Equals<T>): Signal<T>
}

export const composed = factory<ComposedFactoryFunction>('composed')
